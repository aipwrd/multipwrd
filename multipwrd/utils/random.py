"""\
MultiPWRD Randomization Utilities
=================================
...
unique identifiers within the MultiPWRD framework. Under the hood, it
...
# useful for creating unique IDs for agents within the MultiPWRD
# framework.
